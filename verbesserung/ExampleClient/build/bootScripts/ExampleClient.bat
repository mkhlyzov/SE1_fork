...
set JARPATH=%APP_HOME%\lib\ExampleClient.jar

@rem Execute ExampleClient
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %EXAMPLE_CLIENT_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%EXAMPLE_CLIENT_EXIT_CONSOLE%" exit 1
exit /b 1
