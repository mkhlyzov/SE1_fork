...
public class GameSettings {
    ...
    public GameSettings(String studentId, EGameMode gameMode, StrategyType playerStrategy, StrategyType enemyStrategy,
            String serverURL, String gameId, int delay, Long fixedSeed) {
